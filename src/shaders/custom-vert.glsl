...
void main()
{
    ...
    float t = cos(float(u_Time) * 0.015);

    modelposition.z = cos(0.03 * t) * modelposition.z + 18.0 * perlinNoise3D(vec3(modelposition));
    modelposition.x = -cos(0.03 * t) * modelposition.x + 18.0 * perlinNoise3D(vec3(modelposition));
    modelposition.y = -cos(0.03 * t) * modelposition.y + 18.0 * perlinNoise3D(vec3(modelposition));
